...
```
![Inputs](https://tecsify.com/blog/wp-content/uploads/2023/11/INPUTS-HTML.png)
...
<form>
    ...
    <input type="radio" id="opc1" name="opciones"/>

    <label for="opc2">Opción 2</label>
    <input type="radio" id="opc2" name="opciones"/>

    <label for="other">Otro</label>
    <input type="radio" id="other" name="opciones"/>
 </form>
```
...
<form>
    ...
    <label for="videogames">Jugar videojuegos</label>
</form>
```
...
<form>
    <label for="cajaTexto">
        ...
        <textarea rows="5" cols="50" id="cajaTexto"></textarea>
    </label>
</form>
```
...
![Formulario](./img/ejercicioFormulario.png)